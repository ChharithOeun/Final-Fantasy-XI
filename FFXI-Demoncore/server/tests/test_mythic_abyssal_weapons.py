"""Tests for mythic abyssal weapons."""
from __future__ import annotations

from server.mythic_abyssal_weapons import (
    ForgeStage,
    MythicAbyssalWeapons,
)


def _complete_first_four(m: MythicAbyssalWeapons, player_id: str):
    for stage in [
...
def test_one_mythic_per_player():
    m = MythicAbyssalWeapons()
