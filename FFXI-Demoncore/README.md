...
This project lives inside the `Final-Fantasy-XI` umbrella monorepo at `ChharithOeun/Final-Fantasy-XI/FFXI-Demoncore`.
...
- `F:\ChharithOeun\Final-Fantasy-XI\FFXI-Demoncore\` — this project, GitHub-tracked.
- `F:\ChharithOeun\Final-Fantasy-XI\FFXI-Demoncore\repos\` — upstream clones (gitignored, ~tens of GB once everything's in).
- `F:\ChharithOeun\Final-Fantasy-XI\FFXI-Demoncore\assets\` — 3D meshes, textures, audio, ML checkpoints (gitignored).
