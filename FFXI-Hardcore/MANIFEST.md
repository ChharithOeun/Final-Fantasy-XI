...
| `Convai-UnrealEngine-SDK` | https://github.com/Conv-AI/Convai-UnrealEngine-SDK | `b24555998031` | 470.6 MB |
...
| `UnrealGenAISupport` | https://github.com/prajwalshettydev/UnrealGenAISupport | `6514568278e4` | 24.8 MB |
...
## Generative agents (LLM-driven autonomous NPCs)

| Repo | Upstream | HEAD | Local size |
|------|----------|------|------------|
| `generative_agents` | https://github.com/joonspk-research/generative_agents | `fe05a71d3e4e` | 484.0 MB |

## Multi-agent reinforcement learning for combat AI

| Repo | Upstream | HEAD | Local size |
|------|----------|------|------------|
| `neural-mmo` | https://github.com/openai/neural-mmo | `38fd0310bc78` | 333.1 MB |
| `PettingZoo` | https://github.com/Farama-Foundation/PettingZoo | `243ca19c64d3` | 240.9 MB |

## Discord OAuth + moderator (replacing PlayOnline)

| Repo | Upstream | HEAD | Local size |
|------|----------|------|------------|
| `discord-oauth2-example` | https://github.com/discord/discord-oauth2-example | `4e0443e82b70` | 42.0 KB |
| `discord-oauth2.py` | https://github.com/treeben77/discord-oauth2.py | `c92a7c52c530` | 196.2 KB |
